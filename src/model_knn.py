...
def predict(X_img_path, knn_clf=None, model_path=None, distance_threshold=0.6):
    ...
    print("face_encodings: ",faces_encodings)
...
if __name__ == "__main__":
    ...
    classifier = train("photos_knn/train", model_save_path="trained_knn_model.clf", n_neighbors=5)
    print("Training complete!")

    # # STEP 2: Using the trained classifier, make predictions for unknown images
    # for image_file in os.listdir("photos_knn/test"):
    #     full_file_path = os.path.join("photos_knn/test", image_file)
    ...
    #         "photos_knn/test", image_file), predictions)
